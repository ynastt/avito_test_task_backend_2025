...
Было решено использовать менеджер транзакций. Опиралась на [статью](https://habr.com/ru/companies/avito/articles/727168/) и [исходный код](https://github.com/avito-tech/go-transaction-manager/tree/main/drivers/sql).
...
6. Метод массовой деактивации пользователей команды и безопасной переназначаемости открытых PR. Какая логика?
